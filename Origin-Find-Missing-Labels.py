...
def log_outcomes(directory, log_name, message):
    ...
    script_name = "Find Missing Labels with Origin Files Script"
...
def main():
    ...
    try:
        # intro text
        print("")
        print("The odds of survival are...")
        print("")
        ...
        for i in directories:
            ...
            labels = get_labels(i)  # Run function to get origin data
            sort_albums(labels)  # Filter out albums that have original labels/cat#s but not edition ones
